...
const residenceTypeSchema = new Schema(
    {
        code: {
            type: Number,
            unique: true,
            trim: true,
            get: (val) => getFormattedCode('RT', val),
        },
        name: {
            type: String,
...
residenceTypeSchema.methods.softDelete = async function (userId) {
...
const ResidenceType = model('ResidenceType', residenceTypeSchema);
